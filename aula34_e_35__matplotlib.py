# -*- coding: utf-8 -*-
"""Aula34_e_35__matplotlib.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Bds5H1wsi9w_T8tRvcP8ZeDC7IBRb2-m
...
#cria um vetor (array) com 7 espacos
np.random.seed(7)
...
title = 'Relação entre expectatova de vida e renda per capta no Brasil'
...
def filtrar_pais(pais,variavel):
  'Filtra algum país da amostra para as variaveis "pop" , "gdPercap", "pop" e"lifeExp"'
  df = px.data.gapminder()
